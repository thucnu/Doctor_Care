...
let initWebRoutes = (app) => {
  ...
  router.post("/api/chat", chatController.createChat);
  router.get("/api/get-chats-by-id", chatController.getChats);
  router.get("/api/find-chat", chatController.findChat);

  router.post("/api/add-message", messageController.addMessage);
  router.get("/api/get-message", messageController.getMessage);

  router.post("/api/checkout", paymentController.checkout);

  router.post("/api/refund", paymentController.refund);
